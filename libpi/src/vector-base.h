...
cp_asm_get(asm_vector_base, p15, 0, c12, c0, 0);
cp_asm_set(asm_vector_base, p15, 0, c12, c0, 0);
...
static inline void *vector_base_get(void) {
    ...
    return (void *)asm_vector_base_get();
}
...
static inline int vector_base_chk(void *vector_base) {
    ...
    // cast to uint32_t* to check alignment
...
static inline void vector_base_set(void *vec) {
    ...
    asm_vector_base_set((unsigned)vec);
